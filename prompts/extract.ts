...
3. **Key Requirements**: Sammel detailliert alle Anforderungen und Aufgaben (Hard Skills, Qualifikationen, Erfahrungen, Aufgaben, Verantwortungen) die für die Stelle benötigt werden (meist zu finden unter "Das bringst du mit" oder "deine Verantwortungen" oder "Dein Profil" oder "Deine Aufgaben")
