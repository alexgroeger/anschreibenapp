...
gcloud services enable file.googleapis.com  # Für Cloud Filestore
```

### 1.2 Cloud Filestore Instance erstellen (für persistente Datenbank)
...
### 1.3 VPC Connector erstellen (für Filestore Zugriff)
...
### 3.1 Ohne persistente Speicherung (Nur für Tests)
...
### 3.2 Mit Cloud Filestore (Empfohlen)
...
### 3.3 Alternative: Cloud Storage FUSE (Workaround)
